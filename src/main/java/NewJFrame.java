...
public class NewJFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jlbMensaje.setFont(new java.awt.Font("Sitka Subheading", 1, 14)); // NOI18N
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(jlbMensaje, javax.swing.GroupLayout.PREFERRED_SIZE, 641, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addComponent(jlbMensaje, javax.swing.GroupLayout.PREFERRED_SIZE, 111, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        );
    ...
    private void jButtonSelectFileActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSelectFileActionPerformed
        ...
        try {
            ...
            FileNameExtensionFilter filtroIMG = new FileNameExtensionFilter("Imagenes o Fotografias bmp","bmp" );
            
            openFile.setFileFilter(filtroIMG);
    ...
    String claveEncriptation;
    String mensaje01;
    String vi;
    private void jButtonReadyActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonReadyActionPerformed
        claveEncriptation = jTextFieldLlave.getText();
        vi = jTextFieldVi.getText();
        
        
        if((claveEncriptation.length()!= 16) && (vi.length()!=16)){
            validar++;
           jlbMensaje.setText("Error: "+ validar +  ", verifique los parametros a ingresar y vuelve a cargar la imagen");
        }else{
        
        if(optionMode == 0){
            jlbMensaje.setText("Los datos ingresados han sido recibidos de manera correcta");
